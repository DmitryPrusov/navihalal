...
class Halal_Contact_Form
{

    public function __construct()
    {
        add_action('admin_post_nopriv_contact_form', array($this, 'processing_contact_form'));
        add_action('admin_post_contact_form', array($this, 'processing_contact_form'));

        add_action( 'wp_print_scripts', array ($this, 'run_ajax_script'));
    ...
    public function run_ajax_script () {

        wp_enqueue_script( 'halal_certificate_submit',  plugin_dir_url( __FILE__ ) . '/scripts/halal_certificate_submit.js' );
    ...
    public function processing_contact_form()
    {
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
            ...
            $fullname = isset($_POST['full-name-field']) ? self::clean($_POST['full-name-field']) : '';
            $email = isset($_POST['email-field']) ? self::clean($_POST['email-field']) : '';
            $number = isset($_POST['number-field']) ? self::clean($_POST['number-field']) : '';
            $company_name = isset($_POST['company-name-field']) ? self::clean($_POST['company-name-field']) : '';
            ...
            $comment = isset($_POST['comment-field']) ? self::clean($_POST['comment-field']) : '';
